...
const Sidebar = ({ sections, onSectionToggle, onSaveChanges }) => {
  ...
  return (
    <div className="w-72 bg-gray-50 text-gray-800 h-screen fixed shadow-lg overflow-y-auto hide-scrollbar flex flex-col justify-between">
      <div>
            ...
            {section.name === "Navbar" ? (
              ...
              <>
                <JobSectionCustomization
                  section={section}
                  onJobSectionChange={(data) =>
                    console.log("Job Section updated:", data)
                  }
                />
              </>
            ) : section.name === "Footer" ? (
